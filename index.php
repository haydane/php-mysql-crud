  ...
  <div id="wrapper">
    <div class="container">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                <a class="btn btn-danger" name="delete" href="./controller/process.php?delete=<?php echo $row['id']; ?>">Delete</a>
            </td>
            </tr>
            <?php endwhile; ?>
      ...
      <form action="./controller/process.php" method="POST">
        ...
        <div class="form-group">
          <label>Phone</label>
          <input type="text" id="phone" name="phone" value="<?php echo $phone; ?>"  class="form-control" placeholder="phone">
        </div>
